...
<div class="bg-gray-900 px-20 py-16 rounded-lg mb-8 relative overflow-hidden">
    ...
    <p class="text-sm text-gray-400 mt-2">Proyecto de desarrollo Web Laravel</p>
    <img src="{{ Vite::asset('resources/images/web.png') }}" alt="" class="absolute -right-[0rem] -bottom-[0rem] ">
</div>
<div class="px-4">
    ...
    <div class="grid grid-cols-1 gap-4 mb-4">
        @foreach ($posts as $post)
            <a href="{{route('post',$post->slug)}}" class="bg-gray-100 rounded-lg px-6 py-4">
                ...
                <h2 class="text-ls text-gray-900 mt-2">{{$post->title}}</h2>
